...
void ADC_Init(void);
float ADC_Conv(char);
void ADC_Afficher_Tension(char, float);
# 11 "main.c" 2
...
void main(void) {
    ...
    while(1){
        ...
        if(mesure){
            ...
            freq = 1./((8./(float)2000000UL) * ((float)tmr1 + (float)temps));
        }
        ...
        if (pg == 0){
            ...
            LCD_SetCursor(0x20, 1,1);
            LCD_Print(0x20, str0);
            LCD_SetCursor(0x20, 8,2);
            ADC_Afficher_Tension(0x20, ADC_Conv(0b00110));



            LCD_SetCursor(0x20, 1,3);
            LCD_Print(0x20, str1);
            LCD_SetCursor(0x20, 8,4);
            ADC_Afficher_Tension(0x20, ADC_Conv(0b00111));
            LCD_SetCursor(0x20, 18,4);
            LCD_Print(0x20, pg1);
            ...
            LCD_SetCursor(0x20, 1,1);
            LCD_Print(0x20, str2);
            LCD_SetCursor(0x20, 6,2);
            FREQ_Afficher(0x20, freq);
            LCD_SetCursor(0x20, 18,4);
            LCD_Print(0x20, pg2);

            T1CONbits.TMR1ON = 1;
        }
        _delay((unsigned long)((500)*(2000000UL/4000.0)));
